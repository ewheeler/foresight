...
Another direction is dimensionality reduction technique. We observed a clear separation of clusters using a
UMAP technique supervised by the Spike target variable. Using the dataset reduced with this technique
could be a better alternative to a principal component analysis our statistical model uses.
