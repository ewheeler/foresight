...
![Predictions for 2023-01 from transformer model](imgs/fig-y_pred_proba-transformer-202301.png){width=50%}

![Predictions for 2023-01 from xgboost model](imgs/fig-y_pred_proba-xgboost-202301.png){width=50%}

![Predictions for 2023-01 from ffnn model](imgs/fig-y_pred_proba-ffnn-202301.png){width=50%}
...
to create $512x1$ vectors or article level samples to create $512x50$ matrices
...
alternative could be generating daily averages and combining them into $512x31$ (largest number of days in a month)
