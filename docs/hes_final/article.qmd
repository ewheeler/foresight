...
Further investigation showed that while overall numeric metrics look similar, the Transformer-based text-only model appeared to generalized better 
...
In this work we explored the possibility of predicting future geopolitical conflict escalation at a country level using a global
collection of news publications. We compared the usage of text-only data and data enriched with country labels and social indicators. We
