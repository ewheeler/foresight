...
Our task of modeling conflict escalation required a precise definition of what conflict escalation is. Prior work has treated this as a binary classification task, asking whether or not conflict escalated in a given month, and we adopt this approach as well. [@10.1093/jeea/jvac025]
...
{{< embed figs.ipynb#tbl-best-max-metrics >}}

{{< embed figs.ipynb#tbl-best-min-metrics >}}
...
applied both statistical machine learning and deep learning transformer architecture models.
...
We think there are many ways to extend this work. We can group them to align with our initial research and
...
On the transormers side, the output of the encoder also represented a reduced dimension dataset
further fed into the second transformer, the classifier. Using the output of the encoder as input to other
classifiers could be another direction of research.
...
Building a more robust data processing pipeline is another important direction. This would involve
