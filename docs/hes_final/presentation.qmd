...
- The encoder was used to reduce the dimensionality of the embedding corpus by analyzing a subset of article embeddings and returning a single vector of substantially reduced size.
- Analogous to the role of a convolutional layer in a CNN. 
